public class Jugador extends Personaje implements Ataque,AtaqueEspecial{
	...
	*****************************************************************/	
	...
	/******** Metodo: get_obj ***************************************
		Descripcion: Retorna estado inventario
		Retorno: Retorna 0 o 1
	*****************************************************************/	
	...
	*****************************************************************/	
	...
	/******** Metodo: get_item2 ***************************************
		Descripcion: Obtiene el objeto del jugador
		Retorno: Retorna el objeto del jugador
	*****************************************************************/
	
	public Objeto get_item1(){
		return obj1;
	...
	******************************************************************/
	...
	public Objeto get_item2(){
		return obj2;	
	}

	/******** Metodo: get_pp2 ***************************************
		Descripcion: Obtiene los puntos de poder del jugador
		Retorno: Retorna los puntos de poder del jugador
	******************************************************************/	
